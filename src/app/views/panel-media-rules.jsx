...
import {ManifestActions, ManifestStore, MediaRulesContainer, ErrorBox} from 'app'; // eslint-disable-line import/no-extraneous-dependencies
	...
	render() {
		...
		if (mediaIndex !== false && this.state.manifest && this.state.manifest.parsed.medias) {
			if (mediaIndex >= this.state.manifest.parsed.medias.length) {
				...
				mediaPanel = <MediaRulesContainer editable/>;
			}
		}
